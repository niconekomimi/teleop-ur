...
4. Start the collector node
5. Start / stop recording, or discard the last demo
6. Use `Go Home`, `Go Home Zone`, or `Set Current Pose as Home`
7. Start inference and then explicitly enable inference execution if needed
...
| `src/teleop_control_py/config/teleop_params.yaml` | Teleop behavior |
