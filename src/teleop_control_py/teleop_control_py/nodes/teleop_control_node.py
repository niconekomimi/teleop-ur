...
class TeleopControlNode(Node):
    ...
    def _declare_parameters(self, robot_profile) -> None:
        ...
        self.declare_parameter("quest3_max_relative_orientation_deg", 90.0)
        self.declare_parameter("quest3_linear_axis_mapping", [0, 1, 2])
        self.declare_parameter("quest3_angular_axis_mapping", [1, 0, 2])
        ...
        self.declare_parameter("quest3_orientation_axis_mapping", [1, 0, 2])
