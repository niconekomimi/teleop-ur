...
from .device_profiles import JoyProfile, build_profiles, choose_profile_and_device, normalize_axis
...
class JoyDriverNode(Node):
    def __init__(self) -> None:
        ...
        self.get_logger().info("multi_joy_driver started, publishing to /joy")
